...
(function () {
  ...
  function navHTML() {
    ...
    return '<header class="nav" id="nav"><div class="wrap nav-inner">' +
      ...
      '<div class="nav-right"><a class="nav-phone" href="tel:' + CFG.HQ_TEL + '">' + I.phone + CFG.HQ_PHONE + '</a><a class="btn btn-black btn-sm" href="' + CFG.APPLY_URL + '" target="_blank" rel="noopener">Get pre-approved</a><a class="btn btn-line btn-xs nav-pay" href="' + CFG.PAY_URL + '" target="_blank" rel="noopener">Make a payment</a><a class="btn btn-line btn-xs nav-staff" href="' + S + '/team-login">Staff Portal</a></div>' +
      '</div></header>';
  }
  function footerHTML() {
    var S = CFG.SITE;
